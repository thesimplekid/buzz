...
#[derive(Clone, Debug, Default, Eq, PartialEq, Serialize, Deserialize)]
pub struct ManagedAgentLifecycleResponse {
    pub agent: ManagedAgentInfo,
}
...
#[derive(Clone, Debug, Default, Eq, PartialEq, Serialize, Deserialize)]
pub struct ManagedAgentRestoreResponse {
    pub agents: Vec<ManagedAgentInfo>,
    pub started: Vec<String>,
    pub failed: Vec<ManagedAgentRestoreFailure>,
}

#[derive(Clone, Debug, Default, Eq, PartialEq, Serialize, Deserialize)]
pub struct ManagedAgentRestoreFailure {
    pub pubkey: String,
    pub name: String,
    pub error: String,
}
...
pub fn preference_store_kind(
    kind: ChannelPreferenceKind,
) -> crate::app_data::ChannelPreferenceStoreKind {
    match kind {
        ChannelPreferenceKind::Stars => crate::app_data::ChannelPreferenceStoreKind::Stars,
        ChannelPreferenceKind::Mutes => crate::app_data::ChannelPreferenceStoreKind::Mutes,
    }
}

pub fn preference_ids(
    kind: ChannelPreferenceKind,
