...
use crate::client::{
    ...
    Reminder, ThreadSummary, TuiRelayClient, UserProfile, WindowCursor, CHANNEL_WINDOW_HEAD_LIMIT,
};
...
pub struct RefreshResult {
    ...
    pub channel_sort_modes: Option<BTreeMap<String, String>>,
...
async fn run_primary_refresh(
    ...
    let channel_sort_modes = if *kind == RefreshKind::Full {
        client
            .channel_sort_store()
            .await
            .ok()
