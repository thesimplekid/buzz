{
  description = "Buzz development runtime and services";
          ...
          relayModule = nixpkgs.lib.nixosSystem {
            ...
            modules = [
              self.nixosModules.buzz-relay
              {
                ...
                services.buzz-relay = {
                  enable = true;
                  package = pkgs.writeShellScriptBin "buzz-relay" "";
                  host = "::1";
                  port = 3456;
                  autoMigrate = false;
                  openFirewall = true;
      ...
      devShells = forAllSystems (system:
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              ${commonShellHook}
              echo "Buzz dev shell: relay, CLI, and agent tooling. Use 'just relay' to start the relay."
            '';
          };
          ...
          runtime = pkgs.mkShell {
            ...
            shellHook = ''
              ${runtimeShellHook}
              echo "Buzz runtime shell: buzz and ACP agent tools available"
            '';
          };
