...
use crate::client::{Channel, Message, UserProfile};
...
const COMMANDS: &[CommandDescriptor] = &[
    ...
    CommandDescriptor {
        id: CommandId::PairMobileDevice,
        label: "Pair mobile device",
        aliases: &["mobile pairing", "connect phone", "transfer identity"],
        keybinding: None,
        scope: CommandScope::Global,
    },
    CommandDescriptor {
...
impl App {
    ...
    async fn dispatch_command(&mut self, id: CommandId) {
        match id {
            ...
            CommandId::OpenAgents => self.focus_agents(),
            ...
            CommandId::PairMobileDevice => self.focus_mobile_pairing(),
