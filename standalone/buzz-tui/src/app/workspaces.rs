...
use crate::app::{clamp_index, App, Focus, TimelineMode};
...
impl App {
    ...
    pub fn active_workspace_repos_dir(&self) -> Option<String> {
        self.workspace_config
            .workspaces
            .get(self.workspace_config.active_index())
            .and_then(|workspace| workspace.repos_dir.clone())
    }
    ...
    pub(super) fn reset_workspace_view_state(&mut self) {
        ...
        self.channel_snapshot_cache.clear();
        self.pending_active_refresh = false;
        self.loading_channel_id = None;
        self.pending_read_state_sync = false;
        ...
        self.sidebar_width = self.workspace_config.layout.sidebar_width;
        self.detail_width = self.workspace_config.layout.detail_width;
        self.agent_panel_height = self.workspace_config.layout.agent_panel_height;
        self.detail_panel_visible = self.workspace_config.layout.detail_panel_visible;
        self.agent_panel_visible = self.workspace_config.layout.agent_panel_visible;
        self.selected_agent = 0;
        self.relay_agents.clear();
        self.relay_agents_refresh_requested = self.agent_panel_visible;
        self.agent_turn_metrics.clear();
