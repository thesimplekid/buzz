...
pub struct WorkspaceConfig {
    ...
    /// Mention display-name to pubkey mappings for each saved draft.
    ///
    /// The message body contains only the human-readable `@name`; these
    /// sidecar refs become `p` tags when the draft is sent, matching Desktop.
    #[serde(default)]
    pub draft_mentions: BTreeMap<String, BTreeMap<String, String>>,
